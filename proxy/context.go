...
type Context struct {
	...
	Handlers  []Handler              // the Handlers associated with the current host
	//
	attrs      map[string]interface{}
	attrKeys   []string // list of host parameter names
...
// Param returns the named parameter value that is found in the URL path matching the current host.
...
// Next calls the rest of the Handlers associated with the current host.
...
// Abort skips the rest of the Handlers associated with the current host.
